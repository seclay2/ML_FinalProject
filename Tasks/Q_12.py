def Q_12(self, X_train_scaled, X_test_scaled, y_train, y_test, learning_rate=0.001, nIteration=7000):
    ...
    for i in range(nIteration):
        ...
        x_indi = x_temp[random_index:random_index+1]
        y_indi = y_train[random_index:random_index+1]
        gradient = x_indi.T.dot(x_indi.dot(beta) - y_indi)
